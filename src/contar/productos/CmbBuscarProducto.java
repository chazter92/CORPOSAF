...
public class CmbBuscarProducto extends WebComboBox{
    ...
    private FrmProducto ventanaPadre;
    
    public CmbBuscarProducto(FrmProducto ventanaPadre) {
        super();
    ...
    private void createUI(){
        ...
        cargarProductos(Catalogos.getProductos());
        setProductoSeleccionado(Catalogos.getProductos().get(0));
        getEditor().getEditorComponent().addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (!buscado.isEmpty()) {
                    cargarProductos(new ArrayList(connProducto.busquedaSKUConcepto(buscado.trim()).values()));
                } else {
                    cargarProductos(Catalogos.getProductos());
                }
        ...
        if(item != null){
            ...
            if(!itemStr.isEmpty()){
                ...
                if(datosProducto.length>2){
                    BDO_Producto productoSel = Catalogos.buscarProducto(datosProducto[0]);
                    if(productoSel !=null){
